...
Button Button1 = { 600,500, 200,70, "Aleatoria"};
Button Button2 = { 600,400, 200,70, "Borrar"};
Button Button3 = { 600,100, 200,70, "Dibujar" };
...
void menuOlustur() {
	glutCreateMenu(menu);
	glutAddMenuEntry("prueba", 0);
	glutAddMenuEntry("prueba", 1);
	glutAddMenuEntry("prueba", 2);
	glutAddMenuEntry("prueba", 3);
	glutAddMenuEntry("prueba", 4);
